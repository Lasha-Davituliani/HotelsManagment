    ...
    public partial class newTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 14, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7716), new DateTime(2024, 4, 24, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7727) },
                    { 2, new DateTime(2024, 4, 14, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7734), new DateTime(2024, 5, 14, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7735) },
                    { 3, new DateTime(2024, 4, 14, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7755), new DateTime(2024, 5, 4, 1, 47, 42, 149, DateTimeKind.Local).AddTicks(7756) }
                });
